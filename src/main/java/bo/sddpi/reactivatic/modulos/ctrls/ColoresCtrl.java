...
@RestController
@RequestMapping("apirest/colores")
public class ColoresCtrl {
    ...
    @PostMapping
    ResponseEntity<?> adicionar(@Valid @RequestBody Colores color, BindingResult resultado){
        Map<String, Object> mensajes = new HashMap<>();
    ...
    ResponseEntity<?> eliminar(@PathVariable Long id){
        ...
        mensajes.put("mensaje", "El color ha sido eliminado con éxito");
