...
import bo.profesional.cesarnvf.modulos.entidades.Subrubros;
...
public interface ISubrubrosAod {
    ...
    @Results({
        @Result(property = "rubro", column = "ifore1", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.IRubrosAod.dato"))
    })
