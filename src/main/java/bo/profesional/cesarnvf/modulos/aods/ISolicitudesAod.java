...
public interface ISolicitudesAod {
    ...
    @Results({
        @Result(property = "empresa", column = "idfore1", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.IEmpresasAod.dato")),
        @Result(property = "solicitudproductos", column = "idfore2", many = @Many(select = "bo.profesional.cesarnvf.modulos.aods.ISolicitudesproductosAod.datosl" ))
    })
    ...
    @Results({
        @Result(property = "cliente", column = "idfore1", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.IClientesAod.dato")),
        @Result(property = "solicitudproductos", column = "idfore2", many = @Many(select = "bo.profesional.cesarnvf.modulos.aods.ISolicitudesproductosAod.datosl" ))
    })
    ...
    @Results({
        @Result(property = "empresa", column = "idfore1", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.IEmpresasAod.dato")),
        @Result(property = "solicitudproductos", column = "idfore2", many = @Many(select = "bo.profesional.cesarnvf.modulos.aods.ISolicitudesproductosAod.datosl" )),
        @Result(property = "cliente", column = "idfore3", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.IClientesAod.dato"))
    })
