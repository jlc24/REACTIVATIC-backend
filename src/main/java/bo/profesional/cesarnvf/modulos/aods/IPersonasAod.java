...
public interface IPersonasAod {
    ...
    @Results({
        @Result(property = "tipogenero", column = "ifore1", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.ITiposgenerosAod.dato"))
    })
    ...
    @Results({
        @Result(property = "tipogenero", column = "idtipogenero", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.ITiposgenerosAod.dato"))
    })
