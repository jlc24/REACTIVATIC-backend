...
import bo.profesional.cesarnvf.modulos.entidades.Bitacoras;
...
public interface IBitacorasAod {
    ...
    @Results({
        @Result(property = "usuario", column="idusuario", one = @One(select = "bo.profesional.cesarnvf.modulos.aods.IUsuariosAod.dato"))
    })
